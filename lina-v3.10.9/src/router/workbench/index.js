      ...
      children: [
        {
          ...
          component: () => import('@/views/myticket'),
          meta: { title: '权限申请-nodes', permissions: [] }
        },
        {
          path: 'Auth-Application-mysql',
          name: 'AuthApplicationMysql',
          component: () => import('@/views/myticket/AuthApplicationMysql'),
        ...
        },
        {
          ...
          meta: { title: '我的申请', permissions: [] }
        },
        {
          path: 'My-Approval',
          name: 'MyApproval',
          component: () => import('@/views/myticket/MyApproval'),
          meta: { title: '我的审批', permissions: ['assets.view_domain'] }
        }
      ]
    },
    {
